            ...
            <div class="row justify-content-center align-items-center text-justify">
                <div class="col-lg-10 privacy">
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                        with regards to the information that they shared and/or collect in Maestloper Media. This policy is
                    ...
                    <p>Maestloper Media follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <p>Like any other website, Maestloper Media uses "cookies". These cookies are used to store information
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                        are used in their respective advertisements and links that appear on Maestloper Media, which are
                    ...
                    <p>Note that Maestloper Media has no access to or control over these cookies that are used by
                        third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>Maestloper Media's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>Maestloper Media does not knowingly collect any Personal Identifiable Information from children under
